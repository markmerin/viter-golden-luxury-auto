  ...
  const {
    ...
    queryFn: async ({ pageParam = 1 }) =>
      await queryDataInfinite(
        `${apiVersion}/client/records-files/search`, // search endpoint
        `${apiVersion}/client/records-files/page/${pageParam}/${store.credentials.data.user_other_email}`, // list endpoint
...
export default RecordsFilesList;
