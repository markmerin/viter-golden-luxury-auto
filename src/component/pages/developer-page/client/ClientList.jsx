...
const ClientList = () => {
  ...
  return (
    <>
                    ...
                    return (
                      ...
                      >
                        <td
                          onClick={() =>
                            navigate(
                              `${devNavUrl}/${link}/client/view-info?clientId=${item.client_aid}`
                            )
                          }
      ...
      {store.isArchive && (
        <ModalArchive
          mysqlApiArchive={`${apiVersion}/client/active/${id}`}
      ...
      {store.isRestore && (
        <ModalRestore
          mysqlApiRestore={`${apiVersion}/client/active/${id}`}
      ...
      {store.isDelete && (
        <ModalDelete
          mysqlApiDelete={`${apiVersion}/client/${id}`}
