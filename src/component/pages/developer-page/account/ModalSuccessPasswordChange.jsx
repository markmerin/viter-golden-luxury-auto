...
const ModalSuccessPasswordChange = ({ setChangePasswordSuccess }) => {
    ...
    <>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="ms-3 text-sm font-normal pr-4 ">
            {" "}
            You password has been successfuly changed, you will be logout.
          </div>
        </div>
...
export default ModalSuccessPasswordChange;
