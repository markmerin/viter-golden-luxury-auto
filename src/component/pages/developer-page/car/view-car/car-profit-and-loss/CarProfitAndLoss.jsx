...
import CarProfitAndLossList from "./CarProfitAndLossList";
import ModalAddCarProfitAndLoss from "./ModalAddCarProfitAndLoss";

const CarProfitAndLoss = () => {
    ...
    <>
      ...
      >
        ...
        <div className="w-full pt-3 pb-4">
          <CarProfitAndLossList setItemEdit={setItemEdit} />
        </div>
        <Footer />
      </div>

      {store.isAdd && <ModalAddCarProfitAndLoss itemEdit={itemEdit} />}
...
export default CarProfitAndLoss;
