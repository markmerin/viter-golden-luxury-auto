...
import CarCogsList from "./CarCogsList";
import ModalAddCarCogs from "./ModalAddCarCogs";
    ...
    <>
      ...
      >
        ...
        <div className="w-full pt-3 pb-4">
          ...
          <CarCogsList setItemEdit={setItemEdit} />
        </div>
        <Footer />
      </div>

      {store.isAdd && <ModalAddCarCogs itemEdit={itemEdit} />}
