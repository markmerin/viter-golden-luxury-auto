...
import CarManagementAndCarOwnerSplitReadAndUpdateAction from "./CarManagementAndCarOwnerSplitReadAndUpdateAction";

const CarManagementAndCarOwnerSplitList = ({ setItemEdit }) => {
        ...
        >
          <table className="overflow-auto">
            ...
            <tbody>
              ...
              <tr>
                <td className="text-center sticky left-0 w-[2rem]">1.</td>
                <td className="sticky left-[2rem] !pl-0">Car Management</td>
                <CarManagementAndCarOwnerSplitReadAndUpdateAction
                  item={"car management"}
              ...
              <tr>
                <td className="text-center sticky left-0 ">2.</td>
                <td className="sticky left-[2rem] !pl-0">Car Owner Split</td>
                <CarManagementAndCarOwnerSplitReadAndUpdateAction
                  item={"car owner split"}
                  carProfitAndLoss={carProfitAndLoss}
                  handleEdit={handleEdit}
                />
              </tr>
...
export default CarManagementAndCarOwnerSplitList;
