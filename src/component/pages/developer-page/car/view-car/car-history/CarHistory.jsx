...
import CarHistoryList from "./CarHistoryList";
import ModalAddCarHistory from "./ModalAddCarHistory";
    ...
    <>
      ...
      >
        ...
        <div className="w-full pt-3 pb-4">
          <CarHistoryList setItemEdit={setItemEdit} />
        </div>
        <Footer />
      </div>

      {store.isAdd && <ModalAddCarHistory itemEdit={itemEdit} />}
