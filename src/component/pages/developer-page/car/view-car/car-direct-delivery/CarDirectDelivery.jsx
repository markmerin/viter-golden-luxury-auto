...
import CarDirectDeliveryList from "./CarDirectDeliveryList";
import ModalAddCarDirectDelivery from "./ModalAddCarDirectDelivery";
    ...
    <>
      ...
      >
        ...
        <div className="w-full pt-3 pb-4">
          ...
          <CarDirectDeliveryList setItemEdit={setItemEdit} />
        </div>
        <Footer />
      </div>

      {store.isAdd && <ModalAddCarDirectDelivery itemEdit={itemEdit} />}
