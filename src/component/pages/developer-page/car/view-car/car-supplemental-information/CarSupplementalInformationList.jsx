...
import CarSupplementalInfoReadAndUpdateAction from "./CarSupplementalInfoReadAndUpdateAction";

const CarSupplementalInformationList = ({ setItemEdit }) => {
    ...
    <>
      ...
      <div className="relative z-0 overflow-auto text-center rounded-md">
        ...
        >
          <table className="overflow-auto">
            <thead className={`${isTableScroll && "relative "} z-50 `}>
              <tr className="sticky top-0 !border-0">
                <th className="text-center sticky left-0 w-[2rem]">#</th>
                ...
                profitAndLossSettings?.data.map((item, key) => {
                  return (
                    <tr key={key}>
                      ...
                      <CarSupplementalInfoReadAndUpdateAction
                        item={item}
          ...
          <ul className="grid grid-cols-[15rem,3rem,3rem] gap-5 mt-8 ">
            <li className="font-bold text-left">
              Annual depreciation Percentage %
            </li>
            <li className="font-bold text-center">2023</li>
            <li className="font-bold text-center">2024</li>
          </ul>

          <ul className="grid grid-cols-[15rem,3rem,3rem] gap-5">
            <li className="text-left">Annual depreciation Percentage %</li>
            <li className="text-center">20%</li>
            <li className="text-center">20%</li>
          </ul>
        </div>
      </div>
...
export default CarSupplementalInformationList;
