...
import CarSupplementalInformationList from "./CarSupplementalInformationList";
import ModalAddCarSupplementalInformation from "./ModalAddCarSupplementalInformation";

const CarSupplementalInformation = () => {
    ...
    <>
      ...
      >
        ...
        <div className="w-full pt-3 pb-4">
          <CarSupplementalInformationList setItemEdit={setItemEdit} />
        </div>
        <Footer />
      </div>

      {store.isAdd && (
        <ModalAddCarSupplementalInformation itemEdit={itemEdit} />
      )}
...
export default CarSupplementalInformation;
