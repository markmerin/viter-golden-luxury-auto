...
const ModalAddExpenses = ({ itemEdit }) => {
  ...
  const initVal = {
    expenses_aid: itemEdit ? itemEdit.expenses_aid : "",
    expenses_name: itemEdit ? itemEdit.expenses_name : "",
    expenses_name_old: itemEdit ? itemEdit.expenses_name : "",
  };

  const yupSchema = Yup.object({
    expenses_name: Yup.string().required("Required"),
  });
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(
        itemEdit
          ? `${apiVersion}/expenses/${itemEdit.expenses_aid}`
          : `${apiVersion}/expenses`,
        itemEdit ? "put" : "post",
        values
      ),
