...
const ExpensesList = ({ setItemEdit }) => {
  ...
  const [expensesStatus, setExpensesStatus] = React.useState("all");
    ...
    queryFn: async ({ pageParam = 1 }) =>
      await queryDataInfinite(
        ...
        store.isSearch, // search boolean
        {
          ...
          id: "",
          isFilter,
          expenses_is_active: expensesStatus,
        }
      ),
  ...
  const handleChangeExpensesStatus = (e) => {
    setExpensesStatus(e.target.value);
    setIsFilter(false);
          ...
          <div className="flex items-center gap-2">
            <div className="relative w-28 ">
              ...
              <select
                ...
                onChange={(e) => handleChangeExpensesStatus(e)}
