...
import ModalAddUserTrainee from "./ModalAddUserTrainee";
import UserTraineeList from "./UserTraineeList";
    ...
    <>
      ...
      >
        ...
        <div className="w-full pt-5 pb-4 ">
          <UserTraineeList setItemEdit={setItemEdit} />
        </div>
        <Footer />
      </div>

      {store.isAdd && (
        <ModalAddUserTrainee itemEdit={itemEdit} roles={roles} batch={batch} />
      )}
