...
const IncomeCategoryList = ({ setItemEdit }) => {
  ...
  const [incomeCategoryStatus, setIncomeCategoryStatus] = React.useState("all");
    ...
    queryFn: async ({ pageParam = 1 }) =>
      await queryDataInfinite(
        ...
        store.isSearch, // search boolean
        {
          ...
          id: "",
          isFilter,
          income_category_is_active: incomeCategoryStatus,
        }
      ),
  ...
  const handleArchive = (item) => {
    ...
    setId(item.income_category_aid);
  };
  ...
  const handleChangeIncomeCategoryStatus = (e) => {
    setIncomeCategoryStatus(e.target.value);
    setIsFilter(false);
