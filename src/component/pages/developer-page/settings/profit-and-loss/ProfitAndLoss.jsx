...
import ModalAddProfitAndLoss from "./ModalAddProfitAndLoss";
import ProfitAndLossList from "./ProfitAndLossList";
    ...
    <>
      ...
      >
        ...
        <div className="w-full pt-3 pb-4">
          <ProfitAndLossList setItemEdit={setItemEdit} />
        </div>
        <Footer />
      </div>

      {store.isAdd && <ModalAddProfitAndLoss itemEdit={itemEdit} />}
