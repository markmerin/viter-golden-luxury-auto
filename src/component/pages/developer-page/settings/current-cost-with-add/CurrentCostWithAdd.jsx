...
import CurrentCostWithAddList from "./CurrentCostWithAddList";
import ModalAddCurrentCostWithAdd from "./ModalAddCurrentCostWithAdd";

const CurrentCostWithAdd = () => {
    ...
    <>
      ...
      >
        ...
        <div className="w-full pt-3 pb-4">
          <CurrentCostWithAddList setItemEdit={setItemEdit} />
        </div>
        <Footer />
      </div>

      {store.isAdd && <ModalAddCurrentCostWithAdd itemEdit={itemEdit} />}
...
export default CurrentCostWithAdd;
