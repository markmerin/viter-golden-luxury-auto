...
import ModalAddSupplementalInformation from "./ModalAddSupplementalInformation";
...
const SupplementalInformation = () => {
  ...
  return (
    <>
      <Header />
      <Navigation menu="settings" submenu="supplemental-information" />
      <div
      ...
      >
        ...
        <div className="w-full pt-3 pb-40">
          <SupplementalInformationList setItemEdit={setItemEdit} />
        </div>
        <Footer />
      </div>

      {store.isAdd && <ModalAddSupplementalInformation itemEdit={itemEdit} />}
