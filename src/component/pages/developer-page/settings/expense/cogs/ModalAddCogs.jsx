...
const ModalAddCogs = ({ itemEdit }) => {
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(
        itemEdit
          ? `${apiVersion}/cogs/${itemEdit.cogs_aid}`
          : `${apiVersion}/cogs`,
        itemEdit ? "put" : "post",
        values
      ),
  ...
  const initVal = {
    cogs_name: itemEdit ? itemEdit.cogs_name : "",

    cogs_name_old: itemEdit ? itemEdit.cogs_name : "",
  };

  const yupSchema = Yup.object({
    cogs_name: Yup.string().required("Required"),
  });
