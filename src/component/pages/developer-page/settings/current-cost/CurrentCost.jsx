...
import CurrentCostList from "./CurrentCostList";
import ModalAddCurrentCost from "./ModalAddCurrentCost";
...
const CurrentCost = () => {
  ...
  return (
    <>
      <Header />
      <Navigation menu="settings" submenu="current-cost" />
      <div
      ...
      >
        ...
        <div className="w-full pt-3 pb-4">
          <CurrentCostList setItemEdit={setItemEdit} />
        </div>
        <Footer />
      </div>

      {store.isAdd && <ModalAddCurrentCost itemEdit={itemEdit} />}
