...
import ModalAddPurchaseDocument from "./ModalAddPurchaseDocument";
    ...
    <>
      ...
      >
        ...
        <div className="w-full pt-3 pb-40">
          <PurchaseDocumentList setItemEdit={setItemEdit} />
        </div>
        <Footer />
      </div>

      {store.isAdd && <ModalAddPurchaseDocument itemEdit={itemEdit} />}
