...
const TotalCarValueList = ({ setItemEdit }) => {
  ...
  const {
    ...
    `${apiVersion}/total-car-value`, // endpoint
    "get", // method
    "totalcarvalue" // key
  );
      ...
      <div className="relative z-0 overflow-auto text-center rounded-md">
        ...
        >
          <table className="overflow-auto">
            ...
            <tbody>
              {(isLoading || totalcarvalue?.data.length === 0) && (
              ...
              {totalcarvalue?.data.map((item, key) => (
                <tr key={key} className="relative group">
                  <td className="text-center">{counter++}.</td>
                  <td className="whitespace-nowrap">{item.car_value_name}</td>
