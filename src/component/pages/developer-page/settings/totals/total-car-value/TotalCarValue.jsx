...
import ModalAddTotalCarValue from "./ModalAddTotalCarValue";
import TotalCarValueList from "./TotalCarValueList";
    ...
    <>
      ...
      >
        ...
        <div className="w-full pt-3 pb-40">
          <TotalCarValueList setItemEdit={setItemEdit} />
        </div>
        <Footer />
      </div>

      {store.isAdd && <ModalAddTotalCarValue itemEdit={itemEdit} />}
