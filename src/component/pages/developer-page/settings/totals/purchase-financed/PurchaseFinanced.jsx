...
import PurchaseFinancedList from "./PurchaseFinancedList";
import ModalAddPurchaseFinanced from "./ModalAddPurchaseFinanced";

const PurchaseFinanced = () => {
    ...
    <>
      ...
      >
        ...
        <div className="w-full pt-3 pb-40">
          <PurchaseFinancedList setItemEdit={setItemEdit} />
        </div>
        <Footer />
      </div>

      {store.isAdd && <ModalAddPurchaseFinanced itemEdit={itemEdit} />}
...
export default PurchaseFinanced;
