...
const PurchaseFinancedList = ({ setItemEdit }) => {
  ...
  const {
    ...
    isFetching,
    error,
    data: purchasefinanced,
  } = useQueryData(
    `${apiVersion}/purchase-financed`, // endpoint
    "get", // method
    "purchasefinanced" // key
  );
      ...
      <div className="relative z-0 overflow-auto text-center rounded-md">
        ...
        >
          <table className="overflow-auto">
            ...
            <tbody>
              {(isLoading || purchasefinanced?.data.length === 0) && (
              ...
              {purchasefinanced?.data.map((item, key) => (
                <tr key={key} className="relative group">
                  <td className="text-center">{counter++}.</td>
                  <td className="whitespace-nowrap">
                    {item.purchase_financed_name}
                  </td>
