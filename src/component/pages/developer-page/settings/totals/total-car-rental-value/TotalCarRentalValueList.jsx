...
const TotalCarRentalValueList = ({ setItemEdit }) => {
  ...
  const {
    ...
    isFetching,
    error,
    data: totalcarrentalvalue,
  } = useQueryData(
    `${apiVersion}/total-car-rental-value`, // endpoint
    "get", // method
    "totalcarrentalvalue" // key
  );
      ...
      <div className="relative z-0 overflow-auto text-center rounded-md">
        ...
        >
          <table className="overflow-auto">
            ...
            <tbody>
              {(isLoading || totalcarrentalvalue?.data.length === 0) && (
              ...
              {totalcarrentalvalue?.data.map((item, key) => (
                <tr key={key} className="relative group">
                  <td className="text-center">{counter++}.</td>
                  <td className="whitespace-nowrap">
                    {item.car_rental_value_name}
                  </td>
