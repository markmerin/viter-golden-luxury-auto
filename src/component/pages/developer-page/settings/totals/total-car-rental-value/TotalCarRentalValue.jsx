...
import TotalCarRentalValueList from "./TotalCarRentalValueList";
import ModalAddCarRentalValue from "./ModalAddCarRentalValue";

const TotalCarRentalValue = () => {
    ...
    <>
      ...
      >
        ...
        <div className="w-full pt-3 pb-40">
          <TotalCarRentalValueList setItemEdit={setItemEdit} />
        </div>
        <Footer />
      </div>

      {store.isAdd && <ModalAddCarRentalValue itemEdit={itemEdit} />}
...
export default TotalCarRentalValue;
