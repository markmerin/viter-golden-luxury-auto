...
--
-- Table structure for table `glav1_settings_cogs`
--

CREATE TABLE `glav1_settings_cogs` (
...
--
-- Dumping data for table `glav1_settings_cogs`
--

INSERT INTO `glav1_settings_cogs` (`cogs_aid`, `cogs_name`, `cogs_is_active`, `cogs_created`, `cogs_datetime`) VALUES
...
--
-- Indexes for table `glav1_settings_cogs`
--
ALTER TABLE `glav1_settings_cogs`
...
--
-- AUTO_INCREMENT for table `glav1_settings_cogs`
--
ALTER TABLE `glav1_settings_cogs`
  MODIFY `cogs_aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
COMMIT;
