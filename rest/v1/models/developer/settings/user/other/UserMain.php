...
class UserOther
{
    ...
    public function create()
    {
        try {
            ...
            $query->execute([
                "user_other_id" => $this->user_other_id,
    ...
    public function search()
    {
        try {
            ...
            $sql .= "user.user_other_name like :user_other_name ";
            $sql .= ") ";
            $sql .= "order by user.user_other_is_active desc, ";
            $sql .= "user.user_other_id asc ";
            $query = $this->connection->prepare($sql);
            $query->execute([
                ...
                "user_other_name" => "%{$this->user_other_search}%",
            ]);
        } catch (PDOException $ex) {
            $query = false;
        }
    ...
    public function readById()
    {
        try {
            ...
            $sql .= "order by user_other_id asc ";
            $query = $this->connection->prepare($sql);
            $query->execute([
